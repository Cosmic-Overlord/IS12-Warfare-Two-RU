...
/datum/controller/subsystem/day_cycle/Initialize()
	phases = list(
		new /datum/day_cycle_phase("#000000", 5 MINUTES,  "midnight"),
		new /datum/day_cycle_phase("#110500", 2 MINUTES,  "dawn_start"),
		new /datum/day_cycle_phase("#9e4f1b", 4 MINUTES,  "sunrise"),
		new /datum/day_cycle_phase("#a9b2c4", 8 MINUTES,  "noon"),
		new /datum/day_cycle_phase("#a35520", 4 MINUTES,  "sunset"),
		new /datum/day_cycle_phase("#110500", 3 MINUTES,  "dusk_end"),
	)
